...
async function main() {
  ...
  const estimateHands = async () => {
    ...
    for (const hand of hands) {
      ...
      // Resumindo: de acordo com as coordenadas das juntas das mãos o fp vai saber me falar se o dedo esta full curl, no curl, pra qual direção esta apontando aquele dedo. Ou seja, retornando a poseData, que nada mais é a posição do dedo e o gesture, o gesto formado pelos dedos.
